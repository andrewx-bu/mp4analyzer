...
Usage: python benchmark_comparison.py --before --after --file video.mp4
"""
...
def run_benchmark(video_file: str) -> dict:
    ...
    loader = VideoLoader()
    metadata, collection = loader.load_video_file(video_file)
...
def main():
    ...
    parser.add_argument('--file', required=True, help='Video file to benchmark')
